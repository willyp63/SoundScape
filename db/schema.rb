...
ActiveRecord::Schema.define(version: 20160816201012) do
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.string   "request_env",   null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "picture_url",     default: "http://res.cloudinary.com/dcwxxqs4l/image/upload/v1469825821/nobody_wix2c9.jpg"
